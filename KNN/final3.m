...
%
%      FINAL3('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in FINAL3.M with the given input arguments.
%
%      FINAL3('Property','Value',...) creates a new FINAL3 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before final3_OpeningFcn gets called.  An
...
% Last Modified by GUIDE v2.5 01-Mar-2020 17:54:43
...
% Choose default command line output for final3
...
set(handles.edit1,'string',num2str(FF));

D=xlsread('trainn.xlsx');

training=D(:,1:6);

group =D(:,7);  % Class

C1= knnclassify(FF, training, group);
set(handles.edit2,'string',C1);
